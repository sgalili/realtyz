    ...
    <Card dir="rtl" className="border-primary/20">
      <CardHeader className="space-y-1">
        ...
        <CardDescription className="text-xs">
          הקלד או הקלט כלל אישי — למשל "מעכשיו תמיד תדגיש חנייה ומעלית בדירות בהרצליה" או "אל תפנה לאנשי קשר בלשון זכר גנרית". הכלל יוטמע אוטומטית לכל יצירת תוכן, תגובה, צ'אט וקריינות קולית.
        </CardDescription>
      </CardHeader>
