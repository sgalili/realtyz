...
export function PageHero() {
  ...
  return (
    <div
      dir="rtl"
      data-page-hero
      className="relative w-full shrink-0 overflow-hidden text-[#1b2a4f] print:hidden"
      style={{ backgroundColor: '#fdf251' }}
    >
      ...
      >
        ...
        <SidebarTrigger
          className="h-10 w-10 text-[#1b2a4f] hover:bg-[#1b2a4f]/10 hover:text-[#1b2a4f] [&_svg]:!h-6 [&_svg]:!w-6"
        ...
        <h1 className="pointer-events-none absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 whitespace-nowrap pt-[10px] pb-[20px] text-center text-xl font-bold tracking-tight text-[#1b2a4f] sm:text-2xl">
          {title}
        </h1>
