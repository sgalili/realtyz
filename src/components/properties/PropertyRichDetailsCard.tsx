  ...
  return (
    <Card className="p-4 sm:p-5 space-y-5" dir="rtl">
      {aboutText && (
        <section>
          <h2 className="text-base font-bold text-primary mb-2 inline-flex items-center gap-2">
            <FileText className="h-4 w-4" /> על הנכס
          </h2>
          <p className="text-sm leading-relaxed text-foreground/80 whitespace-pre-line">{aboutText}</p>
        </section>
      )}
      ...
      {furnitureEntries.length > 0 && (
        <section>
          <h2 className="text-base font-bold text-primary mb-2 inline-flex items-center gap-2">
            <Sofa className="h-4 w-4" /> פירוט הריהוט
          </h2>
      ...
      {additionalEntries.length > 0 && (
        <section>
          <h2 className="text-base font-bold text-primary mb-2 inline-flex items-center gap-2">
            <ListChecks className="h-4 w-4" /> פרטים נוספים
          </h2>
      ...
      {chartData.length > 1 && (
        <section>
          <h2 className="text-base font-bold text-primary mb-2 inline-flex items-center gap-2">
            <TrendingUp className="h-4 w-4" /> היסטוריית מחיר
          </h2>
      ...
      {hasCoords && (
        <section>
          <h2 className="text-base font-bold text-primary mb-2 inline-flex items-center gap-2">
            <MapPin className="h-4 w-4" /> מיקום על המפה
          </h2>
          ...
          <div className="mt-3 flex flex-wrap items-center gap-2">
            <Button asChild size="sm">
              <a href={navUrl!} target="_blank" rel="noopener noreferrer">
                <Navigation className="h-4 w-4 ms-1" /> נווט לנכס
              </a>
            </Button>
