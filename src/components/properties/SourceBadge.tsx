...
const META: Record<PropertySource, { label: string; short: string; className: string }> = {
  mine: { label: 'המאגר שלי', short: 'ש', className: 'bg-emerald-50 text-emerald-700 border-emerald-200' },
  ...
  yad2: { label: 'יד-2', short: 'Y', className: 'bg-amber-50 text-amber-700 border-amber-200' },
  external: { label: 'חיצוני', short: 'E', className: 'bg-slate-50 text-slate-700 border-slate-200' },
};
