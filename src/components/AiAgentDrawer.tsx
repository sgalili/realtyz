...
const PAGE_QUICK_ACTIONS: Record<string, Array<{ label: string; prompt: string }>> = {
  '/': [
    ...
    { label: 'לידים פעילים', prompt: 'מי 10 הלידים הכי פעילים השבוע לפי מספר הודעות?' },
    { label: 'ערים מובילות', prompt: 'מה 5 הערים עם הכי הרבה לידים רשומים?' },
  ],
  '/lead-crm': [
    { label: 'ניתוח סנטימנט לפי עיר', prompt: 'מה הסנטימנט הממוצע של לידים בכל עיר?' },
    { label: 'לידים לא פעילים', prompt: 'מי הלידים שלא היה להם אינטראקציה מעל שבועיים?' },
    { label: 'התפלגות נאמנות', prompt: 'כמה לידים יש בכל דרגת נאמנות (status)?' },
  ],
  '/live-conversations': [
    { label: 'סיכום שיחות היום', prompt: 'כמה שיחות התקיימו היום ומה הסנטימנט שלהן?' },
    { label: 'מילות מפתח בולטות', prompt: 'מהן 10 המילים הכי נפוצות בהודעות של לידים ב-7 ימים אחרונים?' },
    { label: 'לידים עצבניים', prompt: 'מי הלידים שהביעו סנטימנט שלילי בשיחות האחרונות?' },
  ],
  '/campaigns': [
  ...
  '/conversation-analytics': [
    ...
    { label: 'יחס AI לליד', prompt: 'מה היחס בין הודעות AI להודעות לידים ב-7 ימים אחרונים?' },
    { label: 'ערים שקטות', prompt: 'מאיזה ערים לא היו שיחות בשבוע האחרון?' },
  ],
};

const DEFAULT_ACTIONS = [
  { label: 'סיכום כללי', prompt: 'תן לי סיכום כללי של מצב הקמפיין: כמה לידים, כמה שיחות, סנטימנט כללי' },
  { label: 'בעיות דחופות', prompt: 'האם יש לידים עם סנטימנט שלילי שצריך לטפל בהם?' },
  { label: 'נתונים כלליים', prompt: 'כמה לידים, שיחות, וקמפיינים יש במערכת?' },
];
