...
const PAGE_QUICK_ACTIONS: Record<string, Array<{ label: string; prompt: string }>> = {
  '/': [
    ...
    { label: 'בוחרים פעילים', prompt: 'מי 10 הבוחרים הכי פעילים השבוע לפי מספר הודעות?' },
    { label: 'ערים מובילות', prompt: 'מה 5 הערים עם הכי הרבה בוחרים רשומים?' },
  ],
  '/voter-crm': [
    { label: 'ניתוח סנטימנט לפי עיר', prompt: 'מה הסנטימנט הממוצע של בוחרים בכל עיר?' },
    { label: 'לידים לא פעילים', prompt: 'מי הבוחרים שלא היה להם אינטראקציה מעל שבועיים?' },
    { label: 'התפלגות נאמנות', prompt: 'כמה בוחרים יש בכל דרגת נאמנות (status)?' },
  ],
  '/live-conversations': [
    { label: 'סיכום שיחות היום', prompt: 'כמה שיחות התקיימו היום ומה הסנטימנט שלהן?' },
    { label: 'מילות מפתח בולטות', prompt: 'מהן 10 המילים הכי נפוצות בהודעות של בוחרים ב-7 ימים אחרונים?' },
    { label: 'בוחרים עצבניים', prompt: 'מי הבוחרים שהביעו סנטימנט שלילי בשיחות האחרונות?' },
  ],
  '/campaigns': [
  ...
  '/conversation-analytics': [
    ...
    { label: 'יחס AI לבוחר', prompt: 'מה היחס בין הודעות AI להודעות בוחרים ב-7 ימים אחרונים?' },
    { label: 'ערים שקטות', prompt: 'מאיזה ערים לא היו שיחות בשבוע האחרון?' },
  ],
};

const DEFAULT_ACTIONS = [
  { label: 'סיכום כללי', prompt: 'תן לי סיכום כללי של מצב הקמפיין: כמה בוחרים, כמה שיחות, סנטימנט כללי' },
  { label: 'בעיות דחופות', prompt: 'האם יש בוחרים עם סנטימנט שלילי שצריך לטפל בהם?' },
  { label: 'נתונים כלליים', prompt: 'כמה בוחרים, שיחות, וקמפיינים יש במערכת?' },
];
