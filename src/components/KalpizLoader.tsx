import { KalpizWordmarkSvg } from '@/components/KalpizWordmarkSvg';

export function KalpizLoader({ size = 'md', label }: { size?: 'sm' | 'md' | 'lg'; label?: string }) {
  ...
  return (
    <div className="flex flex-col items-center gap-3">
      <div className={`relative ${sizeMap[size]} flex items-center justify-center`}>
        ...
        <KalpizWordmarkSvg className={`text-primary ${logoMap[size]} animate-kalpiz-pulse`} title="Kalpiz AI" />
      </div>
