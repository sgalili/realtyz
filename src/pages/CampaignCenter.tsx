  ...
  const handleGenerateFirstComment = async (postBody?: string) => {
    ...
    try {
      ...
      const styleInstructions = [
        ...
        '"דירות גן חדשות בהרצליה הירוקה כמעט שלא מגיעות לשוק.\\n\\nאם הייתם יכולים לבחור…\\n\\nדירת גן עם גינה פרטית\\n\\nאו\\n\\nפנטהאוז עם מרפסת גדולה?\\n\\nכתבו “גן” או “פנטהאוז” בתגובות\\n\\nואם אתם מחפשים דירת גן איכותית בהרצליה, שלחו לי הודעה פרטית או התקשרו\\n\\nאודי ויטמן | 052-2973500"',
        '"אם אתם מחפשים נכס שמשלב איכות חיים, פרטיות, מרחב וגמישות למשפחה, לעבודה מהבית או לאירוח, כדאי להגיע לראות.\\n\\nאודי ויטמן | 052-2973500"',
