...
const FEATURES = [
  ...
  },
  {
    ...
    body: 'ברכות אוטומטיות, תזכורות ומעקבים - מסנן, מדרג ומחמם כל איש קשר חדש, גם ב-3 לפנות בוקר.',
  },
  {
...
const WHATSAPP_POWERS = [
  'שליחת הודעת פתיחה אוטומטית לכל איש קשר חדש בשניות',
...
const FAQ: { q: string; a: string }[] = [
  {
    q: 'איך התמחור עובד?',
    a: 'מחיר חודשי קבוע לפי חבילה - חינם, Agent ₪145, Pro ₪495 ו-Max ₪795. אין תמחור לפי איש קשר ואין עלויות נסתרות. שירותים בצריכה בפועל (SMS, הודעות WhatsApp בתשלום, שיחות AI קוליות) נגרעים מארנק קרדיטים נפרד.',
  },
  {
  ...
  {
    q: 'ה-AI שולח הודעות לאנשי קשר בלי אישור שלי?',
  ...
  {
    q: 'האם המידע של אנשי הקשר שלי מבודד ומאובטח?',
  ...
  },
  {
    ...
    a: 'כן. בחבילת Pro עד 5 משתמשים ובחבילת Max ללא הגבלה, כולל הרשאות לפי תפקיד, פיקוח ויומן פעילות.',
  },
  {
        ...
        <div className="mx-auto w-full max-w-6xl px-4">
          <Reveal>
            ...
            <p className="mx-auto mt-4 max-w-3xl text-center text-lg text-muted-foreground">
              אין יותר צורך במנויים נפרדים לכתיבה או תזמון פוסטים בכל הרשתות, ניהול נכסים, ניהול לידים, שליחת הודעות, ניהול יומן, דוחות, ועוד... רילטיז היא לוח בקרה אחד שכולל את כל הכלים שמתווך צריך בעידן ה AI. הכל הולך להשתנות!
            </p>
          </Reveal>
