        ...
        <div className="mx-auto w-full max-w-6xl px-4 pb-6 pt-8 text-center sm:pt-10">
          <Reveal delay={80}>
            ...
            <p className="mx-auto mt-5 max-w-3xl text-center text-base sm:text-xl leading-relaxed text-muted-foreground">
              {'מפספסים לידים חמים רק כי לא מספיקים לענות בזמן? RealtyZ עונה לכל ליד תוך שניות, 24/7, יוצרת ומפרסמת תוכן בכל הרשתות החברתיות ומרכזת את כל ערוצי התקשורת במקום אחד, ישירות מהוואטסאפ שלך.\n\n\n 90% פחות עבודה ידנית. 100% פוקוס על עסקאות.'}
            </p>
          </Reveal>
