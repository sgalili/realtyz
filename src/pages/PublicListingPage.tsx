...
const demoPage: CandidatePage = {
  ...
  headline: 'קמפיין חכם שמקשיב למתעניינים ומתרגם אמון לעסקאות',
  thesis: 'שילוב של מאגר ידע, שיחות AI וניתוח שטח בזמן אמת כדי להגיע לכל מתעניין עם המסר הנכון.',
  pillars: ['שיחה אישית עם כל מתעניין', 'מדידה יומית של תמיכה', 'מסרים חדים שמבוססים על ידע הקמפיין'],
  mandate_goal: 2,
