...
const demoPage: CandidatePage = {
  ...
  headline: 'קמפיין חכם שמקשיב לאנשי קשר ומתרגם אמון לעסקאות',
  thesis: 'שילוב של מאגר ידע, שיחות AI וניתוח שטח בזמן אמת כדי להגיע לכל איש קשר עם המסר הנכון.',
  pillars: ['שיחה אישית עם כל איש קשר', 'מדידה יומית של תמיכה', 'מסרים חדים שמבוססים על ידע הקמפיין'],
  mandate_goal: 2,
