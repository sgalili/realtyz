...
- [Workspace Persona Isolation](mem://features/workspace-persona-isolation) — All AI prompts derive identity+business domain from the active workspace only (workspacePersona.ts); SaaS workspaces get the Realtyz demo-booking persona, never a broker persona.
