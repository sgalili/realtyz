...
$function$;
REVOKE ALL ON FUNCTION public.get_affiliate_marketplace_map(uuid) FROM PUBLIC, anon, authenticated;
GRANT EXECUTE ON FUNCTION public.get_affiliate_marketplace_map(uuid) TO service_role;