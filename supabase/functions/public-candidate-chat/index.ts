...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const system = `אתה צ׳אטבוט ציבורי של עמוד מועמד ב-Kalpiz. ענה בעברית, ב-RTL, בקצרה ובאמינות. אל תמציא עובדות. אם אין מידע במאגר הידע, אמור זאת והצע לפנות לקמפיין.\n\nמועמד: ${page.candidate_name}\nכותרת: ${page.headline}\nתזה: ${page.thesis}\nעמודי תווך: ${JSON.stringify(page.pillars)}\n\nמאגר ידע רלוונטי:\n${kbContext}`;
